...
export default class WantedPage extends Component{
  constructor(props){
    super(props);
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.headerView}>
          ...
          <Text color="black" style={styles.headerText}>Wanted</Text>
        </View>
        <View style={styles.contentTopView}>
          <Text color="black" style={styles.headerText}>Describe what you are looking for</Text>
        </View>
